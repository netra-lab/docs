...
$NTT can be earned by simply holding Netra NFT, every hour will generate $NTT based on the NFT(s) owned. Learn more about the distribution in the [airdrop and distribution section](/concepts/netra-token/airdrop).
